...
model_w_aug = keras.models.load_model("without_power_feature_tap70_layer4_span50_SR64_715.h5")
model_w_aug.summary()
...
for epoch in range(training_epochs):
    ...
    print("Epoch now", epoch, "Power now", power_train[epoch])
    print(
        "Q_train Sim now", Q_train_predict,
        "Q_train Sim ref now", Q_train_ref
    )
    model_w_aug.save("without_power_feature_tap70_layer4_span50_SR64_750.h5")
...
for epoch in range(test_epochs):
    ...
    savedModel = keras.models.load_model("without_power_feature_tap70_layer4_span50_SR64_750.h5")
...
np.save("without_power_feature_tap70_layer4_span50_SR64_750", Q_prop_ref3)
np.save("without_power_feature_tap70_layer4_span50_SR64_750_ref", Q_prop_ref4)
...
# plt.xticks(x)
# plt.yticks(y)
plt.title("without_power_feature_tap70_layer4_span50_SR64_750")
plt.show()
