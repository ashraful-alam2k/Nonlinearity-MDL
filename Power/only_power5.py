...
model_w_aug = keras.models.load_model("only_power_5_250.h5")
model_w_aug.summary()
...
for epoch in range(training_epochs):
    ...
    model_w_aug.save("only_power_5_500.h5")
...
for epoch in range(test_epochs):
    ...
    savedModel = keras.models.load_model("only_power_5_500.h5")
...
np.save("only_power_5_500", Q_prop_ref3)
np.save("only_power_5_500_ref", Q_prop_ref4)
