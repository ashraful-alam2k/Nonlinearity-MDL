...
# model_w_aug = keras.models.load_model('model_with_SR_feature_600.h5')
...
for epoch in range(training_epochs):
    ...
    model_w_aug.save("model_with_SR_feature_power6.h5")
print(
...
for epoch in range(test_epochs):
    ...
    savedModel = keras.models.load_model("model_with_SR_feature_power6.h5")
...
np.save("with_SR_feature_power6", Q_prop_ref3)
np.save("with_SR_feature_power6_ref", Q_prop_ref4)
...
plt.legend()
plt.title("model_with_SR_feature_power6")
plt.show()
