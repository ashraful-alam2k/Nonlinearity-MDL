...
def create_dataset_m(x_pol_in_complex, y_pol_in_complex, x_pol_des_complex, n_sym1):
...
#     metrics=["accuracy"],
# )
model_w_aug = keras.models.load_model('without_SR_and_span_500.h5')
...
for epoch in range(training_epochs):
    ...
    model_w_aug.save("without_SR_and_span_700.h5")
print(
...
for epoch in range(5):
    ...
    savedModel = keras.models.load_model("without_SR_and_span_700.h5")
...
np.save("without_SR_and_span_700", Q_prop_ref3)
np.save("without_SR_and_span_700_ref", Q_prop_ref4)
...
plt.legend()
plt.title("without_SR_and_span_700")
plt.show()
