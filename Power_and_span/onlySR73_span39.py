...
model_w_aug = keras.models.load_model('onlySR73_span39_300.h5')
...
for epoch in range(training_epochs):
    ...
    model_w_aug.save("onlySR73_span39_600.h5")
...
for epoch in range(1):
    ...
    savedModel = keras.models.load_model("onlySR73_span39_600.h5")
