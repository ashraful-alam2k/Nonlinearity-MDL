...
model_w_aug = keras.models.load_model('onlySR56_span46.h5')
...
for epoch in range(training_epochs):
    ...
    model_w_aug.save("onlySR56_span46_300.h5")
...
for epoch in range(1):
    ...
    savedModel = keras.models.load_model("onlySR56_span46_300.h5")
    ...
    Q_prop_ref3 = 20 * np.log10(np.sqrt(2) * special.erfcinv(2 * BER_test))
    Q_prop_ref4 = 20 * np.log10(np.sqrt(2) *
    ...
    print("Q_test Exp now", Q_prop_ref3,
          "Q-factor  Exp ref", Q_prop_ref4)

np.save("onlySR56_span46_300", Q_prop_ref3)
np.save("onlySR56_span46_300_ref", Q_prop_ref4)

plt.bar(symbol_rate, Q_prop_ref3, label="Exp now NN", color="blue")
plt.bar(symbol_rate, Q_prop_ref4, label="Exp ref no NN", color="red")
plt.legend()
plt.title("onlySR56_span46_300")
plt.show()
