...
model_w_aug = keras.models.load_model('onlySR64_span45_300.h5')
...
for epoch in range(training_epochs):
    ...
    model_w_aug.save("onlySR64_span45_500.h5")
...
for epoch in range(1):
    ...
    savedModel = keras.models.load_model("onlySR64_span45_500.h5")
