...
for epoch in range(test_epochs):
    ...
    savedModel = keras.models.load_model("model_only_span_10_200.h5")
...
np.save("model_only_span_10_power6_60", Q_prop_ref3)
np.save("model_only_span_10_power6_60_ref", Q_prop_ref4)
...
plt.title("model_only_span_10_power6_60")
plt.xticks(x)
plt.yticks(y)
plt.legend()
plt.grid()
