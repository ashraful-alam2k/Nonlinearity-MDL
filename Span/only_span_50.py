...
# model_w_aug = keras.models.load_model("model_only_span_10_power8_800.h5")
# model_w_aug.summary()
# #
# # # # NN
...
#     )
#     print("Epoch now", epoch, "Span now", n_span_train)
#     print(
#         "Q_train Sim now", Q_train_predict,
#         "Q_train Sim ref now", Q_train_ref
#     )
#     model_w_aug.save("model_only_span_30_power8_400.h5")
...
for epoch in range(test_epochs):
    ...
    savedModel = keras.models.load_model("model__span_only50_tap70_epochs1000.h5")
...
np.save("model_only_span_50_power6_60", Q_prop_ref3)
np.save("model_only_span_50_power6_60_ref", Q_prop_ref4)
...
plt.title("model_only_span_50_power6_60")
plt.xticks(x)
plt.yticks(y)
plt.legend()
plt.grid()
